...
import { Button, Popover, Menu, Badge, Col, Row } from 'antd'
...
import { HeaderBox, HeaderLogoBox, MenuLiText, HeaderMeta, UserMeta } from './styled'
  ...
  return (
    <HeaderBox className="header-box">
      <Row>
        ...
        <Col span={18} className="header-col-menu">
